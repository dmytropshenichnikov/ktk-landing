...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Цемент',
    spec: 'М400 і М500',
    priceFrom: 'від 158 грн/мішок',
    description: 'Свіжий цемент для кладки, бетону та ремонтних робіт.',
    image: '/photos/cement.jpg',
    details: ['Марки М400 і М500', 'Мішки для приватного та професійного використання', 'Для кладки, бетону та ремонту'],
  },
];
